...
-(void)initGuideView{
    ...
    for (int i = 0; i<imageArray.count; i++) {
        ...
        if (i==2) {
            ...
            [button setTitleColor:kButtonFontColor forState:UIControlStateNormal];
            button.layer.cornerRadius = 2;
            button.layer.borderWidth = 1;
            button.layer.borderColor = kButtonFontColor.CGColor;
    ...
    self.pageControl.currentPageIndicatorTintColor = kButtonFontColor;
